...
namespace LINQtoCSV
{
	...
	public class CsvContext
	{
		...
		=> ReadData<T>(fileName, null, fileDescription);

		public IEnumerable<T> Read<T>(StreamReader stream) where T : class, new() => Read<T>(stream, new CsvFileDescription());

		public IEnumerable<T> Read<T>(string fileName) where T : class, new() => Read<T>(fileName, new CsvFileDescription());

		public IEnumerable<T> Read<T>(StreamReader stream, CsvFileDescription fileDescription) where T : class, new() => ReadData<T>(null, stream, fileDescription);
		...
		public void Write<T>(IEnumerable<T> values, TextWriter stream) => Write(values, stream, new CsvFileDescription());

		public void Write<T>(IEnumerable<T> values, string fileName) => Write(values, fileName, new CsvFileDescription());

		public void Write<T>(IEnumerable<T> values, TextWriter stream, CsvFileDescription fileDescription) => WriteData(values, null, stream, fileDescription);
